...
import '../styles/global.css'
import Navbar from '../components/Navbar' // Imports should omit extensions
import { AuthProvider } from '../context/AuthContext' // Imports should omit extensions
import React from 'react'; // Required for React components in Next.js

// Metadata is already correctly typed for TypeScript in Next.js
export const metadata = {
  title: 'My Portfolio',
  description: 'Modern, professional portfolio built with Next.js and Tailwind CSS',
...
// RootLayout is a TypeScript function component
export default function RootLayout({
  children,
}: {
  children: React.ReactNode // Correct TypeScript type annotation for props
}) {
  return (
    <html lang="en">
      {/* The body ensures:
